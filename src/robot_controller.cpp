...
double wheelbase = 0.120;                          //Wheelbase, in m
...
int main(int argc, char** argv){
  ...
  ros::Subscriber sub = n.subscribe("robotA_speed", 50, handle_speed);
  ros::Publisher odom_pub = n.advertise<nav_msgs::Odometry>("robotA_odom", 50);
  ...
  double vy = 0.0;
  double vth = 0.0;
  char base_link[] = "/robotA_base_link";
  char odom[] = "/robotA_odom";
  ros::Duration d(1.0);
